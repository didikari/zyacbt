                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-flat" id="btn-show-password-tambah" title="Tampilkan Password" type="button"><i id="icon-show-password-tambah" class="fa fa-eye"></i></button>
                                        <button class="btn btn-flat" id="btn-generate-password-tambah" title="Buat Password Acak" type="button"><i class="fa fa-key"></i></button>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										...
										<button class="btn btn-flat" id="btn-generate-password-edit" title="Buat Password Acak" type="button"><i class="fa fa-key"></i></button>
									</span>
								</div>
                            </div>
...
<script lang="javascript">
	...
	function showpassword_tambah(){
		var x = document.getElementById("tambah-password");
		if (x.type === "password") {
			x.type = "text";
			$("#icon-show-password-tambah").removeClass("fa-eye");
			$("#icon-show-password-tambah").addClass("fa-eye-slash");
		} else {
			x.type = "password";
			$("#icon-show-password-tambah").removeClass("fa-eye-slash");
			$("#icon-show-password-tambah").addClass("fa-eye");
		}
	}
    ...
    function tambah(){
        ...
        $('#tambah-username').val('');
        $('#tambah-password').val('');
        $('#tambah-password').attr('type', 'password');
        $("#icon-show-password-tambah").removeClass("fa-eye-slash").addClass("fa-eye");
        $('#tambah-nama').val('');
        $('#tambah-email').val('');
		$('#tambah-detail').val('');
    ...
    function edit(id){
        ...
        $.getJSON('<?php echo site_url().'/'.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
                ...
                $("#icon-show-password").removeClass("fa-eye-slash").addClass("fa-eye");
    ...
    $(function(){
		...
		$("#btn-show-password-tambah").click(function(){
			showpassword_tambah();
		});
		$("#btn-generate-password-tambah").click(function(){
			var newPass = generateRandomPassword();
			$("#tambah-password").val(newPass);
			$("#tambah-password").attr('type', 'text');
			$("#icon-show-password-tambah").removeClass("fa-eye").addClass("fa-eye-slash");
		});
		$("#btn-generate-password-edit").click(function(){
			var newPass = generateRandomPassword();
			$("#edit-password").val(newPass);
			$("#edit-password").attr('type', 'text');
			$("#icon-show-password").removeClass("fa-eye").addClass("fa-eye-slash");
		});

                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button class="btn btn-flat btn-default btn-sm" id="btn-show-password" title="Tampilkan Password" type="button"><i id="icon-show-password" class="fa fa-eye"></i></button>
                                                <button class="btn btn-flat btn-default btn-sm" id="btn-generate-password" title="Buat Password Acak" type="button"><i class="fa fa-key"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
